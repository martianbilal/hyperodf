...
'''
Creates a dict of syscall names and their arguments


++++++++++++++++++++++++++++++++++++++++++++++
| name | nargs | list of args (type) {max 6} |
| name | nargs | list of args (type) {max 6} |
| name | nargs | list of args (type) {max 6} |
| name | nargs | list of args (type) {max 6} |
| name | nargs | list of args (type) {max 6} |
...
Modify it to look like this (for easier parsing in C):

+++++++++++++++++++++++++++++++++++++++++++++++++++++
| name | code | nargs | list of args (type) {max 6} |
| name | code | nargs | list of args (type) {max 6} |
| name | code | nargs | list of args (type) {max 6} |
| name | code | nargs | list of args (type) {max 6} |
| name | code | nargs | list of args (type) {max 6} |
