...
extern int ustat (__dev_t __dev, struct ustat *__ubuf) __attribute__ ((__nothrow__ , __leaf__));
...
int sys_ustat(struct tcb *tcp)
{
 if ((!((tcp)->flags & 0x04))) {
  ...
  struct_ustat ust;
  if (!umoven_or_printaddr((tcp), (tcp->u_arg[1]), sizeof(*(&ust)), (void *) (&ust))) {
   tprint_struct_begin();
   do { tprints_field_name("f_tfree"); tprintf("%llu", (sizeof((ust).f_tfree) == sizeof(char) ? (unsigned long long) (unsigned char) ((ust).f_tfree) : sizeof((ust).f_tfree) == sizeof(short) ? (unsigned long long) (unsigned short) ((ust).f_tfree) : sizeof((ust).f_tfree) == sizeof(int) ? (unsigned long long) (unsigned int) ((ust).f_tfree) : sizeof((ust).f_tfree) == sizeof(long) ? (unsigned long long) (unsigned long) ((ust).f_tfree) : (unsigned long long) ((ust).f_tfree))); } while (0);
   tprint_struct_next();
   do { tprints_field_name("f_tinode"); tprintf("%llu", (sizeof((ust).f_tinode) == sizeof(char) ? (unsigned long long) (unsigned char) ((ust).f_tinode) : sizeof((ust).f_tinode) == sizeof(short) ? (unsigned long long) (unsigned short) ((ust).f_tinode) : sizeof((ust).f_tinode) == sizeof(int) ? (unsigned long long) (unsigned int) ((ust).f_tinode) : sizeof((ust).f_tinode) == sizeof(long) ? (unsigned long long) (unsigned long) ((ust).f_tinode) : (unsigned long long) ((ust).f_tinode))); } while (0);
   tprint_struct_end();
  }
 }
 return 0;
