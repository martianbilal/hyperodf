...
decode_loop_info(struct tcb *const tcp, const kernel_ulong_t addr)
{
 ...
 if (!((tcp)->qual_flg & 0x002)) {
  tprint_struct_next();
  do { tprints_field_name("lo_init"); for (size_t i_ = 0; i_ < (sizeof(((info)).lo_init) / sizeof((((info)).lo_init)[0]) + (sizeof(int[-1 + 2 * !!(!__builtin_types_compatible_p(__typeof__((((info)).lo_init)), __typeof__(&(((info)).lo_init)[0])))]) * 0)); ++i_) { if (i_) tprint_array_next(); else tprint_array_begin(); tprintf("%#llx", (sizeof(((info)).lo_init[i_]) == sizeof(char) ? (unsigned long long) (unsigned char) (((info)).lo_init[i_]) : sizeof(((info)).lo_init[i_]) == sizeof(short) ? (unsigned long long) (unsigned short) (((info)).lo_init[i_]) : sizeof(((info)).lo_init[i_]) == sizeof(int) ? (unsigned long long) (unsigned int) (((info)).lo_init[i_]) : sizeof(((info)).lo_init[i_]) == sizeof(long) ? (unsigned long long) (unsigned long) (((info)).lo_init[i_]) : (unsigned long long) (((info)).lo_init[i_]))); } tprint_array_end(); } while (0);
  tprint_struct_next();
  do { tprints_field_name("reserved"); for (size_t i_ = 0; i_ < (sizeof(((info)).reserved) / sizeof((((info)).reserved)[0]) + (sizeof(int[-1 + 2 * !!(!__builtin_types_compatible_p(__typeof__((((info)).reserved)), __typeof__(&(((info)).reserved)[0])))]) * 0)); ++i_) { if (i_) tprint_array_next(); else tprint_array_begin(); tprintf("%#llx", (sizeof(((info)).reserved[i_]) == sizeof(char) ? (unsigned long long) (unsigned char) (((info)).reserved[i_]) : sizeof(((info)).reserved[i_]) == sizeof(short) ? (unsigned long long) (unsigned short) (((info)).reserved[i_]) : sizeof(((info)).reserved[i_]) == sizeof(int) ? (unsigned long long) (unsigned int) (((info)).reserved[i_]) : sizeof(((info)).reserved[i_]) == sizeof(long) ? (unsigned long long) (unsigned long) (((info)).reserved[i_]) : (unsigned long long) (((info)).reserved[i_]))); } tprint_array_end(); } while (0);
 } else {
  tprint_struct_next();
...
print_loop_info64(struct tcb *const tcp, const struct loop_info64 *const info64)
{
 ...
 if (!((tcp)->qual_flg & 0x002)) {
  tprint_struct_next();
  do { tprints_field_name("lo_init"); for (size_t i_ = 0; i_ < (sizeof(((*info64)).lo_init) / sizeof((((*info64)).lo_init)[0]) + (sizeof(int[-1 + 2 * !!(!__builtin_types_compatible_p(__typeof__((((*info64)).lo_init)), __typeof__(&(((*info64)).lo_init)[0])))]) * 0)); ++i_) { if (i_) tprint_array_next(); else tprint_array_begin(); tprintf("%#llx", (sizeof(((*info64)).lo_init[i_]) == sizeof(char) ? (unsigned long long) (unsigned char) (((*info64)).lo_init[i_]) : sizeof(((*info64)).lo_init[i_]) == sizeof(short) ? (unsigned long long) (unsigned short) (((*info64)).lo_init[i_]) : sizeof(((*info64)).lo_init[i_]) == sizeof(int) ? (unsigned long long) (unsigned int) (((*info64)).lo_init[i_]) : sizeof(((*info64)).lo_init[i_]) == sizeof(long) ? (unsigned long long) (unsigned long) (((*info64)).lo_init[i_]) : (unsigned long long) (((*info64)).lo_init[i_]))); } tprint_array_end(); } while (0);
 } else {
  tprint_struct_next();
  tprint_more_data_follows();
 }
...
decode_loop_config(struct tcb *const tcp, const kernel_ulong_t addr)
{
 ...
 if (!is_filled((const char *) (config.__reserved), 0, sizeof(config.__reserved) + (sizeof(int[-1 + 2 * !!(!__builtin_types_compatible_p(__typeof__((config.__reserved)), __typeof__(&(config.__reserved)[0])))]) * 0))) {
  tprint_struct_next();
  do { tprints_field_name("__reserved"); for (size_t i_ = 0; i_ < (sizeof(((config)).__reserved) / sizeof((((config)).__reserved)[0]) + (sizeof(int[-1 + 2 * !!(!__builtin_types_compatible_p(__typeof__((((config)).__reserved)), __typeof__(&(((config)).__reserved)[0])))]) * 0)); ++i_) { if (i_) tprint_array_next(); else tprint_array_begin(); tprintf("%#llx", (sizeof(((config)).__reserved[i_]) == sizeof(char) ? (unsigned long long) (unsigned char) (((config)).__reserved[i_]) : sizeof(((config)).__reserved[i_]) == sizeof(short) ? (unsigned long long) (unsigned short) (((config)).__reserved[i_]) : sizeof(((config)).__reserved[i_]) == sizeof(int) ? (unsigned long long) (unsigned int) (((config)).__reserved[i_]) : sizeof(((config)).__reserved[i_]) == sizeof(long) ? (unsigned long long) (unsigned long) (((config)).__reserved[i_]) : (unsigned long long) (((config)).__reserved[i_]))); } tprint_array_end(); } while (0);
 }
 tprint_struct_end();
}
