...
decode_rtc_param(struct tcb *const tcp, const kernel_ulong_t addr, const _Bool get)
{
 ...
 if ((!((tcp)->flags & 0x04)) ^ get) {
  ...
  case 0:
   ...
   break;
  case 1:
   do { tprints_field_name("svalue"); tprintf("%lld", (sizeof((param).svalue) == sizeof(char) ? (long long) (char) ((param).svalue) : sizeof((param).svalue) == sizeof(short) ? (long long) (short) ((param).svalue) : sizeof((param).svalue) == sizeof(int) ? (long long) (int) ((param).svalue) : sizeof((param).svalue) == sizeof(long) ? (long long) (long) ((param).svalue) : (long long) ((param).svalue))); } while (0);
   break;
  case 2:
   ...
   break;
  default:
   do { tprints_field_name("uvalue"); tprintf("%#llx", (sizeof((param).uvalue) == sizeof(char) ? (unsigned long long) (unsigned char) ((param).uvalue) : sizeof((param).uvalue) == sizeof(short) ? (unsigned long long) (unsigned short) ((param).uvalue) : sizeof((param).uvalue) == sizeof(int) ? (unsigned long long) (unsigned int) ((param).uvalue) : sizeof((param).uvalue) == sizeof(long) ? (unsigned long long) (unsigned long) ((param).uvalue) : (unsigned long long) ((param).uvalue))); } while (0);
  }
 }
 if ((!((tcp)->flags & 0x04))) {
  tprint_struct_next();
  do { tprints_field_name("index"); tprintf("%llu", (sizeof((param).index) == sizeof(char) ? (unsigned long long) (unsigned char) ((param).index) : sizeof((param).index) == sizeof(short) ? (unsigned long long) (unsigned short) ((param).index) : sizeof((param).index) == sizeof(int) ? (unsigned long long) (unsigned int) ((param).index) : sizeof((param).index) == sizeof(long) ? (unsigned long long) (unsigned long) ((param).index) : (unsigned long long) ((param).index))); } while (0);
 }
 if (param.__pad) {
  tprint_struct_next();
  do { tprints_field_name("__pad"); tprintf("%#llx", (sizeof((param).__pad) == sizeof(char) ? (unsigned long long) (unsigned char) ((param).__pad) : sizeof((param).__pad) == sizeof(short) ? (unsigned long long) (unsigned short) ((param).__pad) : sizeof((param).__pad) == sizeof(int) ? (unsigned long long) (unsigned int) ((param).__pad) : sizeof((param).__pad) == sizeof(long) ? (unsigned long long) (unsigned long) ((param).__pad) : (unsigned long long) ((param).__pad))); } while (0);
 }
 tprint_struct_end();
