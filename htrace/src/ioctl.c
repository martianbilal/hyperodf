...
SYS_FUNC(ioctl)
{
	...
	/* 	
		Notes [Bilal] : This is the entry point for parsing the 
		information of an ioctl 

		The following debug print statement is printed after 
		printing ioctl and before printing corresponding ids
		and arguments.  
	*/
	// STRACE_PRINTF("[debug] [hyperodf] ioctl called\n");
	if (entering(tcp)) {
