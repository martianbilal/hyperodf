...
print_si_info(struct tcb *tcp, const siginfo_t *sip)
{
 ...
 if (((sip)->si_code <= 0)) {
  ...
  case SI_SIGIO:
   ...
   tprint_struct_next();
   do { tprints_field_name("si_fd"); printfd((tcp), (*sip)._sifields._sigpoll.si_fd); } while (0);
   break;
  default:
   printsigsource(tcp, sip);
  ...
  case 17:
   ...
   tprint_struct_next();
   do { tprints_field_name("si_utime"); print_clock_t((*sip)._sifields._sigchld.si_utime); } while (0);
   tprint_struct_next();
   do { tprints_field_name("si_stime"); print_clock_t((*sip)._sifields._sigchld.si_stime); } while (0);
   break;
  case 4:
   tprint_struct_next();
  ...
  case 7:
   ...
   case BUS_MCEERR_AO:
    tprint_struct_next();
    do { tprints_field_name("si_addr_lsb"); tprintf("%#llx", (sizeof((*sip)._sifields._sigfault.si_addr_lsb) == sizeof(char) ? (unsigned long long) (unsigned char) ((*sip)._sifields._sigfault.si_addr_lsb) : sizeof((*sip)._sifields._sigfault.si_addr_lsb) == sizeof(short) ? (unsigned long long) (unsigned short) ((*sip)._sifields._sigfault.si_addr_lsb) : sizeof((*sip)._sifields._sigfault.si_addr_lsb) == sizeof(int) ? (unsigned long long) (unsigned int) ((*sip)._sifields._sigfault.si_addr_lsb) : sizeof((*sip)._sifields._sigfault.si_addr_lsb) == sizeof(long) ? (unsigned long long) (unsigned long) ((*sip)._sifields._sigfault.si_addr_lsb) : (unsigned long long) ((*sip)._sifields._sigfault.si_addr_lsb))); } while (0);
    break;
   }
   break;
  case 11:
   ...
   case SEGV_BNDERR:
    tprint_struct_next();
    do { tprints_field_name("si_lower"); printaddr((mpers_ptr_t) (*sip)._sifields._sigfault._bounds._addr_bnd._lower); } while (0);
    tprint_struct_next();
    do { tprints_field_name("si_upper"); printaddr((mpers_ptr_t) (*sip)._sifields._sigfault._bounds._addr_bnd._upper); } while (0);
    break;
   case SEGV_PKUERR:
    tprint_struct_next();
    do { tprints_field_name("si_pkey"); tprintf("%llu", (sizeof((*sip)._sifields._sigfault._bounds._pkey) == sizeof(char) ? (unsigned long long) (unsigned char) ((*sip)._sifields._sigfault._bounds._pkey) : sizeof((*sip)._sifields._sigfault._bounds._pkey) == sizeof(short) ? (unsigned long long) (unsigned short) ((*sip)._sifields._sigfault._bounds._pkey) : sizeof((*sip)._sifields._sigfault._bounds._pkey) == sizeof(int) ? (unsigned long long) (unsigned int) ((*sip)._sifields._sigfault._bounds._pkey) : sizeof((*sip)._sifields._sigfault._bounds._pkey) == sizeof(long) ? (unsigned long long) (unsigned long) ((*sip)._sifields._sigfault._bounds._pkey) : (unsigned long long) ((*sip)._sifields._sigfault._bounds._pkey))); } while (0);
    break;
   }
   break;
  case 5:
  ...
  case 31:
   ...
   tprint_struct_next();
   do { tprints_field_name("si_syscall"); const char *nr_prefix_ = ((void *)0); const char *name = syscall_name_arch((*sip)._sifields._sigsys._syscall, (sip->_sifields._sigsys._arch), &nr_prefix_); if (((xlat_verbosity) & ((1 << 2) - 1)) != XLAT_STYLE_ABBREV || !nr_prefix_) tprintf("%llu", (sizeof((*sip)._sifields._sigsys._syscall) == sizeof(char) ? (unsigned long long) (unsigned char) ((*sip)._sifields._sigsys._syscall) : sizeof((*sip)._sifields._sigsys._syscall) == sizeof(short) ? (unsigned long long) (unsigned short) ((*sip)._sifields._sigsys._syscall) : sizeof((*sip)._sifields._sigsys._syscall) == sizeof(int) ? (unsigned long long) (unsigned int) ((*sip)._sifields._sigsys._syscall) : sizeof((*sip)._sifields._sigsys._syscall) == sizeof(long) ? (unsigned long long) (unsigned long) ((*sip)._sifields._sigsys._syscall) : (unsigned long long) ((*sip)._sifields._sigsys._syscall))); if (((xlat_verbosity) & ((1 << 2) - 1)) == XLAT_STYLE_RAW || !name) break; if (!nr_prefix_ || ((xlat_verbosity) & ((1 << 2) - 1)) == XLAT_STYLE_VERBOSE) tprint_comment_begin(); if (nr_prefix_) tprints(nr_prefix_); tprints(name); if (!nr_prefix_ || ((xlat_verbosity) & ((1 << 2) - 1)) == XLAT_STYLE_VERBOSE) tprint_comment_end(); } while (0);
   tprint_struct_next();
