      ...
      size_t elem_size, void *data)
{
 ...
 tprint_struct_begin();
 do { tprints_field_name("unicode"); tprintf("%#llx", (sizeof((*val).unicode) == sizeof(char) ? (unsigned long long) (unsigned char) ((*val).unicode) : sizeof((*val).unicode) == sizeof(short) ? (unsigned long long) (unsigned short) ((*val).unicode) : sizeof((*val).unicode) == sizeof(int) ? (unsigned long long) (unsigned int) ((*val).unicode) : sizeof((*val).unicode) == sizeof(long) ? (unsigned long long) (unsigned long) ((*val).unicode) : (unsigned long long) ((*val).unicode))); } while (0);
 tprint_struct_next();
 do { tprints_field_name("fontpos"); tprintf("%#llx", (sizeof((*val).fontpos) == sizeof(char) ? (unsigned long long) (unsigned char) ((*val).fontpos) : sizeof((*val).fontpos) == sizeof(short) ? (unsigned long long) (unsigned short) ((*val).fontpos) : sizeof((*val).fontpos) == sizeof(int) ? (unsigned long long) (unsigned int) ((*val).fontpos) : sizeof((*val).fontpos) == sizeof(long) ? (unsigned long long) (unsigned long) ((*val).fontpos) : (unsigned long long) ((*val).fontpos))); } while (0);
 tprint_struct_end();
 return 1;
}
static int
...
{
 tprint_struct_begin();
 do { tprints_field_name("charcount"); tprintf("%llu", (sizeof((*cfd).charcount) == sizeof(char) ? (unsigned long long) (unsigned char) ((*cfd).charcount) : sizeof((*cfd).charcount) == sizeof(short) ? (unsigned long long) (unsigned short) ((*cfd).charcount) : sizeof((*cfd).charcount) == sizeof(int) ? (unsigned long long) (unsigned int) ((*cfd).charcount) : sizeof((*cfd).charcount) == sizeof(long) ? (unsigned long long) (unsigned long) ((*cfd).charcount) : (unsigned long long) ((*cfd).charcount))); } while (0);
 tprint_struct_next();
 do { tprints_field_name("charheight"); tprintf("%llu", (sizeof((*cfd).charheight) == sizeof(char) ? (unsigned long long) (unsigned char) ((*cfd).charheight) : sizeof((*cfd).charheight) == sizeof(short) ? (unsigned long long) (unsigned short) ((*cfd).charheight) : sizeof((*cfd).charheight) == sizeof(int) ? (unsigned long long) (unsigned int) ((*cfd).charheight) : sizeof((*cfd).charheight) == sizeof(long) ? (unsigned long long) (unsigned long) ((*cfd).charheight) : (unsigned long long) ((*cfd).charheight))); } while (0);
 tprint_struct_next();
 if (get) {
...
print_console_font_op(struct tcb *const tcp, const struct_console_font_op *cfo)
{
 ...
 switch (cfo->op) {
 case 3:
  do { tprints_field_name("height"); tprintf("%llu", (sizeof((*cfo).height) == sizeof(char) ? (unsigned long long) (unsigned char) ((*cfo).height) : sizeof((*cfo).height) == sizeof(short) ? (unsigned long long) (unsigned short) ((*cfo).height) : sizeof((*cfo).height) == sizeof(int) ? (unsigned long long) (unsigned int) ((*cfo).height) : sizeof((*cfo).height) == sizeof(long) ? (unsigned long long) (unsigned long) ((*cfo).height) : (unsigned long long) ((*cfo).height))); } while (0);
  break;
 default:
  do { tprints_field_name("width"); tprintf("%llu", (sizeof((*cfo).width) == sizeof(char) ? (unsigned long long) (unsigned char) ((*cfo).width) : sizeof((*cfo).width) == sizeof(short) ? (unsigned long long) (unsigned short) ((*cfo).width) : sizeof((*cfo).width) == sizeof(int) ? (unsigned long long) (unsigned int) ((*cfo).width) : sizeof((*cfo).width) == sizeof(long) ? (unsigned long long) (unsigned long) ((*cfo).width) : (unsigned long long) ((*cfo).width))); } while (0);
  tprint_struct_next();
  do { tprints_field_name("height"); tprintf("%llu", (sizeof((*cfo).height) == sizeof(char) ? (unsigned long long) (unsigned char) ((*cfo).height) : sizeof((*cfo).height) == sizeof(short) ? (unsigned long long) (unsigned short) ((*cfo).height) : sizeof((*cfo).height) == sizeof(int) ? (unsigned long long) (unsigned int) ((*cfo).height) : sizeof((*cfo).height) == sizeof(long) ? (unsigned long long) (unsigned long) ((*cfo).height) : (unsigned long long) ((*cfo).height))); } while (0);
 }
 switch (cfo->op) {
 ...
 default:
  tprint_struct_next();
  do { tprints_field_name("charcount"); tprintf("%llu", (sizeof((*cfo).charcount) == sizeof(char) ? (unsigned long long) (unsigned char) ((*cfo).charcount) : sizeof((*cfo).charcount) == sizeof(short) ? (unsigned long long) (unsigned short) ((*cfo).charcount) : sizeof((*cfo).charcount) == sizeof(int) ? (unsigned long long) (unsigned int) ((*cfo).charcount) : sizeof((*cfo).charcount) == sizeof(long) ? (unsigned long long) (unsigned long) ((*cfo).charcount) : (unsigned long long) ((*cfo).charcount))); } while (0);
 }
 switch (cfo->op) {
 case 1:
  if ((!((tcp)->flags & 0x04))) {
