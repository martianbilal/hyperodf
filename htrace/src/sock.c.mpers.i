...
#pragma GCC diagnostic pop
;
_Static_assert((unsigned long long) (IFF_BROADCAST)
      > (unsigned long long) ((IFF_UP)),
...
#pragma GCC diagnostic pop
;
_Static_assert((unsigned long long) (IFF_DEBUG)
      > (unsigned long long) ((IFF_BROADCAST)),
...
#pragma GCC diagnostic pop
;
_Static_assert((unsigned long long) (IFF_LOOPBACK)
      > (unsigned long long) ((IFF_DEBUG)),
...
#pragma GCC diagnostic pop
;
_Static_assert((unsigned long long) (IFF_POINTOPOINT)
      > (unsigned long long) ((IFF_LOOPBACK)),
...
#pragma GCC diagnostic pop
;
_Static_assert((unsigned long long) (IFF_NOTRAILERS)
      > (unsigned long long) ((IFF_POINTOPOINT)),
...
#pragma GCC diagnostic pop
;
_Static_assert((unsigned long long) (IFF_RUNNING)
      > (unsigned long long) ((IFF_NOTRAILERS)),
...
#pragma GCC diagnostic pop
;
_Static_assert((unsigned long long) (IFF_NOARP)
      > (unsigned long long) ((IFF_RUNNING)),
...
#pragma GCC diagnostic pop
;
_Static_assert((unsigned long long) (IFF_PROMISC)
      > (unsigned long long) ((IFF_NOARP)),
...
#pragma GCC diagnostic pop
;
_Static_assert((unsigned long long) (IFF_ALLMULTI)
      > (unsigned long long) ((IFF_PROMISC)),
...
#pragma GCC diagnostic pop
;
_Static_assert((unsigned long long) (IFF_MASTER)
      > (unsigned long long) ((IFF_ALLMULTI)),
...
#pragma GCC diagnostic pop
;
_Static_assert((unsigned long long) (IFF_SLAVE)
      > (unsigned long long) ((IFF_MASTER)),
...
#pragma GCC diagnostic pop
;
_Static_assert((unsigned long long) (IFF_MULTICAST)
      > (unsigned long long) ((IFF_SLAVE)),
...
#pragma GCC diagnostic pop
;
_Static_assert((unsigned long long) (IFF_PORTSEL)
      > (unsigned long long) ((IFF_MULTICAST)),
...
#pragma GCC diagnostic pop
;
_Static_assert((unsigned long long) (IFF_AUTOMEDIA)
      > (unsigned long long) ((IFF_PORTSEL)),
...
#pragma GCC diagnostic pop
;
_Static_assert((unsigned long long) (IFF_DYNAMIC)
      > (unsigned long long) ((IFF_AUTOMEDIA)),
      "Incorrect order in #sorted xlat: IFF_DYNAMIC"
      " is not larger than the previous value");
_Static_assert((unsigned long long) ((1 << 16))
      > (unsigned long long) ((IFF_DYNAMIC)),
      "Incorrect order in #sorted xlat: IFF_LOWER_UP"
      " is not larger than the previous value");
_Static_assert((unsigned long long) ((1 << 17))
      > (unsigned long long) (((1 << 16))),
      "Incorrect order in #sorted xlat: IFF_DORMANT"
      " is not larger than the previous value");
_Static_assert((unsigned long long) ((1 << 18))
      > (unsigned long long) (((1 << 17))),
...
{
 tprintf("%lld", (sizeof(len) == sizeof(char) ? (long long) (char) (len) : sizeof(len) == sizeof(short) ? (long long) (short) (len) : sizeof(len) == sizeof(int) ? (long long) (int) (len) : sizeof(len) == sizeof(long) ? (long long) (long) (len) : (long long) (len)));
 const unsigned int n = (unsigned int) len / sizeof(struct_ifreq);
 if (len > 0 && n * sizeof(struct_ifreq) == (unsigned int) len) {
  tprint_comment_begin();
  tprintf("%llu", (sizeof(n) == sizeof(char) ? (unsigned long long) (unsigned char) (n) : sizeof(n) == sizeof(short) ? (unsigned long long) (unsigned short) (n) : sizeof(n) == sizeof(int) ? (unsigned long long) (unsigned int) (n) : sizeof(n) == sizeof(long) ? (unsigned long long) (unsigned long) (n) : (unsigned long long) (n)));
